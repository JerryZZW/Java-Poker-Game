...
class Decks {
    ...
    public Decks()
    {
        ...
        playDecks = new ArrayList<Card>();
        
        //populate cards into playDecks and saveDecks
        for (int i = 1; i < 5; i++) {
            for (int j = 1; j < 14; j++) {
                try {
    ...
    public List<Card> deal(int numberCards) throws PlayingCardException
    {
        ...
        //remove dealt cards from playDecks and add them to dealtCards
        for(int i = numberCards - 1; i >= 0; i--) {
            dealtCards.add(playDecks.remove(i));
        }
